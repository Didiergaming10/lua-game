...
function story(aName)
	if(aName == "start") then
		...
		createTextfield("The weather took a turn for the worse and you have to stop for the night. You hear the clock, it's midnight.\nin the distance is an old mansion. What will you do?")
		createButton("exit", "nah fuck this actually.")
		createButton("entrance", "You wake up")
	end
